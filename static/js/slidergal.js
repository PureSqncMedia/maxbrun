$(function() {
	...
	function openGallery($gallery){
		...
		*/
		...
		$fp_thumbContainer.animate({'height':'260px'},200,function(){
		...
		$fp_thumbScroller.stop()
						 .animate({'scrollLeft':'600px'},2000,'easeInOutExpo');
		...
		$fp_content_wrapper.find('.content')
			...
			//EB not using image gall in trakdrop just want links to songs.. maybe open player via ajax
			// Want the click to actually go to the link
			//e.preventDefault();
		});					
	}
	...
	function centerImage($obj,open,speed){
		...
		//else if(open)
			//EB again not using enlarge photo for Trakdrop just scrolle/.picker
			//enlarge($obj);
	}
